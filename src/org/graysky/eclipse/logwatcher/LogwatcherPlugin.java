...
public class LogwatcherPlugin extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "Logwatcher";
	...
	public void start(BundleContext context) throws Exception {
		...
		try {
			resourceBundle = ResourceBundle
					.getBundle("org.graysky.eclipse.logwatcher.LogwatcherPluginResources");
		...
		if (getPreferenceStore().contains("logwatcherFont")) {
			m_fontRegistry.put("logwatcherFont", PreferenceConverter
					.getFontDataArray(getPreferenceStore(), "logwatcherFont"));
		}
	...
	public static String getResourceString(String key) {
		ResourceBundle bundle = LogwatcherPlugin.getDefault()
				.getResourceBundle();
		try {
	...
	protected void initializeDefaultPreferences() {
		...
		IPreferenceStore store = LogwatcherPlugin.getDefault()
				.getPreferenceStore();
